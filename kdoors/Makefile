...
pkgdatadir = $(datadir)/kdoors
pkglibdir = $(libdir)/kdoors
pkgincludedir = $(includedir)/kdoors
...
NOOPT_CXXFLAGS =  -fno-exceptions -fno-check-new -Wall -pedantic -W -Wpointer-arith -Wmissing-prototypes -Wwrite-strings -Wno-long-long -fno-builtin -g3 -Wall
NOREPO = -fno-repo
OBJDUMP = @OBJDUMP@
OBJEXT = o
PACKAGE = kdoors
...
#>+ 4
KDE_DIST=Makefile.dist configure.in.in kdoors.lsm kdoors.kdevprj 
